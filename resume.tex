...
\headertype{\linkedin}{\github}{\website}{\phone}{\email}{\location} % Set the order of items here
...
\section{\faGears}{Skills}
 \resumeEntryStart
  \resumeEntryS{Proficient in:} {JavaScript (React, Redux, React Native, Node.js), HTML / CSS, Git, Docker, Firebase}
  \resumeEntryS{Experienced in:} {Gatsby, GraphQL, Google Cloud, AWS, PostgreSQL, Unix, Vue.js, Python}
 \resumeEntryEnd
