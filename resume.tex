...
\section{\faCode}{Work Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Work on tinder.com web client team to deliver performant PWA experience to desktop and mobile users}
      \resumeItem {Redesigned web profile feature to increase web conversion rate, deprecate legacy service and improve SEO}
      \resumeItem {Optimized internal tooling by reducing average CI time and implementing real-time build notifications}
      \resumeItem {Collaborate with mobile platform teams in Agile/Scrum sprint cycles to develop new features}
  ...
  \resumeEntryStart
    \resumeEntryTSDL
      {HackCville}
      {Charlottesville, VA}
      {Lead Instructor, Launch}
      {August 2019 -- May 2020}
    \resumeItemListStart
      \resumeItem {Taught the Advanced Software Engineering course of summer internship program for college students}
      \resumeItem{Developed curriculum focused on fullstack development with React and Node.js}
      \resumeItem {Worked directly with students to provide individualized code review}
    \resumeItemListEnd
    \resumeEntrySD
      {Program Lead, Deploy}{January 2020 -- May 2020}
    \resumeEntrySD
      {Program Coordinator, Deploy}{August 2019 -- December 2019}
    \resumeItemListStart
      \resumeItem {Instructed and managed 10-week course on software development and deployment to 35+ college students}
