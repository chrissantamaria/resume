...
\section{\faCode}{Work Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Teach the Advanced Software Engineering course of summer internship program for college students}
      \resumeItem{Develop curriculum focused on fullstack development with React and Node.js}
      \resumeItem {Work directly with students to provide individualized code review}
    \resumeItemListEnd
    \resumeEntrySD
